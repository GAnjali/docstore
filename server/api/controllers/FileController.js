    ...
    static async getAll(req, res) {
        try {
            ...
            if (allFiles.length > 0) {
                ...
                responseUtil.setSuccess(200, 'No file found');
            }
    ...
    static async getAllByParent(req, res) {
        try {
            ...
            if (allFiles.length > 0) {
                ...
                responseUtil.setSuccess(200, 'No files found');
            }
            return responseUtil.send(res);
        } catch (error) {
            responseUtil.setError(400, error);
    ...
    static async add(req, res) {
        ...
        try {
            ...
            if ((error.message).includes("duplicate key value violates unique constraint"))
                responseUtil.setError(400, "Cannot create a File with Duplicate name, Please provide unique file name");
